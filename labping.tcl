...
$ns trace-all $tf set nf [open labping.nam w] 
$ns namtrace-all $nf 
set n0 [$ns node] 
set n1 [$ns node] 
set n2 [$ns node] 
...
$self instvar node_ puts "The node [$node_ id] received a reply from $from with the round trip time of $rtt" }
